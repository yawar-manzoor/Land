...
const DocumentLibrary = () => {
    ...
    return (
        <div className=" grid gap-8 ">
            <h1 className="text-neutral-600 font-semibold text-3xl">
                Documents Library
            </h1>
            {documents.map((section, index) => (
                <div key={index} className="">
                    <h2 className="text-2xl font-semibold mb-4 text-primary-Main">
                        {section.category}
                    </h2>
                    <div className="grid grid-cols-5 gap-4 ">
                        {section.files.map((file, i) => (
                            <div
                                key={i}
                                className="p-4 bg-[#dfd9ca]/25 bg-primary gap-2  rounded-lg flex flex-col "
                            >
                                <div className=" w-fit p-2 rounded-2xl  bg-[#dfd9ca]/50 shadow-md">
                                    <img
                                        src={Pdf}
                                        alt="PDF icon"
                                        className="w-12 h-12"
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Button className="w-fit px-4 text-primary-Main font-semibold text-sm py-2 bg-primary-200  rounded-lg">
                                        Download
                                    </Button>
                                </div>
                            </div>
