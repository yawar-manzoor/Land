...
const CardReports = ({
    ...
    return (
        <div className="max-w-sm py-7 rounded-2xl overflow-hidden shadow-lg bg-[#DFD9CA]/25 mt-6 cursor-pointer flex flex-col">
            ...
            <div className="p-4 flex space-x-6">
                <Button
                    variant="primary"
                    size="medium"
                    className="bg-primary-Main border rounded-lg font-bold w-full text-white px-6 py-2"
                >
                    Download
                </Button>
                <Button
                    variant="primary"
                    size="medium"
                    className="text-primary-Main border font-bold rounded-lg border-primary-Main px-6 w-full py-2"
                >
                    View
                </Button>
            </div>
